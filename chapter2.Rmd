...
```{r graphical-overview-gender-age}
...
model_attitude_stra_surf <- lm(data = learning2014, formula = points ~ attitude + stra + surf )

summary(model_attitude_stra_surf)
cat(render(wrapFTest(model_attitude_stra_surf),
    pSmallCutoff=0))
```

```{r fit-attitude_stra}
model_attitude_stra <- lm(data = learning2014, formula = points ~ attitude + stra)

summary(model_attitude_stra)
cat(render(wrapFTest(model_attitude_stra),
    pSmallCutoff=0))
```
