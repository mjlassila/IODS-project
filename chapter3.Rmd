```{r chapter-3-setup, echo = FALSE, message = FALSE}
library(MASS)
library(here)
library(data.table)
library(tidyverse)
...
```{r tau-matrix, fig.width=10, fig.height=8, echo = FALSE, cache = TRUE}
...
```{r visualize-going-out,fig.width=10, fig.height=4, echo = FALSE, cache = TRUE}
ggplot(alc) +
    geom_mosaic(aes(x=product(sex, goout), fill=high_use)) +
    labs(
      x = "alcohol usage vs. frequency of going out",
      y = "gender",
      fill='level of alcohol usage',
      title = "Relationship of partying, alcohol use and gender"
    ) +
theme_minimal() +
...
```{r visualize-abseentism,fig.width=10, fig.height=4, echo = FALSE, cache = TRUE}
ggplot(alc) +
    geom_mosaic(aes(x=product(sex, absnt), fill=high_use)) +
    labs(
      x = "alcohol usage vs. abseentism",
      y = "gender",
      fill='level of alcohol usage',
      title = "Relationship of abseentism, alcohol use and gender"
    ) + 
theme_minimal() +
theme(axis.text.x = element_text(angle=45, vjust = 0.5, size = 10))
...
```{r visualize-studytime,fig.width=11, fig.height=6, echo = FALSE, cache = TRUE}
ggplot(alc) +
    geom_mosaic(aes(x=product(sex, studytime), fill=high_use)) +
    labs(
      x = "alcohol usage vs. time dedicated to studies",
      y = "gender",
      fill='level of alcohol usage',
      title = "Relationship of time dedicated to studies, alcohol use and gender"
    ) +
theme_minimal() +
theme(axis.text.x = element_text(angle=45, vjust = 0.5, size = 10))
