...
The dataset has 506 observations and 14 variables. My guess is that observations correspond to cescus districts, eg. subportions of town, as it is very unlikely that Boston metropolitan has over 500 towns.
...
Looking the data my intuition is that low-status housing near highways and industrial areas are more prone to have higher crime rate.
